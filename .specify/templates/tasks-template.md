...
**Tests**: Tests are MANDATORY (Constitution Principle II: Test-Driven Development). Every user story MUST include test tasks, ordered before their corresponding implementation tasks. Tests MUST be written first and MUST fail before implementation begins.
